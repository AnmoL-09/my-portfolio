    ...
    <section className="relative min-h-[90vh] flex flex-col justify-center items-start bg-black text-[#a8a5a5] mt-0">
      <div className="flex flex-row w-full max-w-7xl mx-auto items-center justify-center min-h-[60vh] -mt-30 gap-x-40">
          ...
          <p className="font-normal max-w-4xl w-full text-left mx-auto"
           style={{ fontFamily: 'Poppins, sans-serif', fontSize: '24px', height: '140px', lineHeight: 'normal' }}>
            ...
            <span className="font-bold text-[#393939]"> 3+ years </span>
             ...
             <span className="font-bold text-[#393939]"> 4.6k+ hours</span> of dedicated work, 
        ...
        <div className="flex flex-col items-center justify-center gap-6">
          ...
          <a href="https://github.com/AnmoL-09" target="_blank" rel="noopener noreferrer">
            {/* GitHub SVG */}
            <svg fill="#333333" viewBox="0 0 24 24" width="20" height="20">
          ...
          <a href="https://x.com/SnippetSurge" target="_blank" rel="noopener noreferrer">
            {/* Twitter SVG */}
            <svg fill="#333333" width="20" height="20" viewBox="-143 145 512 512" stroke="#333333">
          ...
          <a href="mailto:anmolmahobiya092@gmail.com" >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0,0,256,256">
              <g fill="#333333" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none" style={{mixBlendMode: "normal"}}><g transform="scale(5.12,5.12)"><path d="M6.91992,6l14.2168,20.72656l-14.9082,17.27344h3.17773l13.13867,-15.22266l10.44141,15.22266h10.01367l-14.87695,-21.6875l14.08008,-16.3125h-3.17578l-12.31055,14.26172l-9.7832,-14.26172z"></path></g></g>
            </svg>
          </a>
        </div>
      </div>
